...
SELECT COUNT(facid) AS 'Number of Facilities that Do not charge a fee'
FROM `Facilities`
WHERE membercost = 0
...
ELSE 'cheap' END AS 'Montly Maintenance Expense'
FROM `Facilities` 
...
FROM 
	...
	WHERE starttime LIKE '2012-09-14%') bookings
INNER JOIN country_club.Members members 
